      ...
      <Container size="narrow">
        <div className="flex min-h-[70vh] flex-col justify-center">
          ...
          <div className="prose prose-lg max-w-none space-y-6 leading-relaxed text-neutral-700">
            <p>
              <span className="text-primary-600 font-mono text-2xl">{`{}`}</span> — it's my symbol.
              The curly braces represent the structure and elegance of code, reminding me that great
              software is built on solid foundations.
            </p>
            ...
            <p>
              ...
              primarily worked with <strong>React and TypeScript</strong> throughout my career, I'm
              not married to any single technology.
            </p>

            <p>
              <strong>JavaScript, TypeScript, and modern web standards</strong> are the foundation
              of my expertise, and I'm always eager to explore new frameworks and tools. I've built
              everything from <strong>real-time visual SCADA editors</strong> to{' '}
            ...
            <p>
              I love creating <strong>meaningful, interactive user experiences</strong> that feel
